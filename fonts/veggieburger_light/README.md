...
import (
  ...
  _ "github.com/gmlewis/go-fonts-v/fonts/veggieburger_light"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from veggieburger_light"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "veggieburger_light", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
