...
import (
  ...
  _ "github.com/gmlewis/go-fonts-v/fonts/veggieburger"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from veggieburger"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "veggieburger", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
