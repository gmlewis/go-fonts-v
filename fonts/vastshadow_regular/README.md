...
import (
  ...
  _ "github.com/gmlewis/go-fonts-v/fonts/vastshadow_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from vastshadow_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "vastshadow_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
