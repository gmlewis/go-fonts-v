...
import (
  ...
  _ "github.com/gmlewis/go-fonts-v/fonts/veterantypewriter"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from veterantypewriter"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "veterantypewriter", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
