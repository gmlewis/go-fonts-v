...
import (
  ...
  _ "github.com/gmlewis/go-fonts-v/fonts/veggieburger_bold"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from veggieburger_bold"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "veggieburger_bold", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
